...
const createVoyageSchema = z.object({
  ...
  voyageLegs: z.object({
    ...
    routeIntelligence: z.object({
      ...
      totalHraDistanceNm: z.number().optional(),
      estimatedSeaDays: z.number().optional(),
      detectedCanals: z.array(z.string()).optional(),
      ecaZones: z.array(z.string()).optional(),
      hraZones: z.array(z.string()).optional(),
      routeLabel: z.string().optional(),
      routeGeometry: z.array(z.array(z.array(z.number()))).optional(),
